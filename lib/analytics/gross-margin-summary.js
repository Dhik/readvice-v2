...
// 100% REAL (revenue from OrderItem − HPP from DailyHpp) → every response carries
// `dummy: false`, so all params are dummy:false. Standing caveats (gross-only, not
// net; HPP coverage <100% inflates blended margin) are surfaced by the engine's
// own coverage fields, not a dummy flag.
export const FIELD_MANIFEST = [
  { key: 'revenue',          label: 'Revenue',          unit: 'IDR',   dummy: false, source: 'REAL' },
  { key: 'hpp',              label: 'COGS (HPP)',       unit: 'IDR',   dummy: false, source: 'REAL' },
  { key: 'grossProfit',      label: 'Gross profit',     unit: 'IDR',   dummy: false, source: 'REAL-DERIVED' },
  { key: 'marginPct',        label: 'Gross margin %',   unit: '%',     dummy: false, source: 'REAL-DERIVED' },
  { key: 'qty',              label: 'Units sold',       unit: 'count', dummy: false, source: 'REAL' },
  { key: 'coveragePct',      label: 'HPP coverage',     unit: '%',     dummy: false, source: 'REAL-DERIVED' },
  { key: 'coveredMarginPct', label: 'Covered margin %', unit: '%',     dummy: false, source: 'REAL-DERIVED' },
]
