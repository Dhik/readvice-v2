...
export async function GET(request) {
  ...
  // Shopee has: impressions (BigInt), clicks, orders (not conversions), ctr, revenue, roas, cpc
  const agg = await prisma.adSpentShopee.aggregate({
    where,
    _sum: { spent: true, revenue: true, impressions: true, clicks: true, orders: true },
  })
